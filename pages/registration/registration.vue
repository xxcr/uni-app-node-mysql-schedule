<template>
	<view class="content">
		...
		<view class="uni-form-item uni-column">
			<input type="tel" v-model="registerUser.tel" class="uni-input" name="" placeholder="请输入手机号" />
		</view>
		<view class="uni-form-item uni-column column-with-btn">
			...
			<image src="../../static/image/captcha.jpg" mode="" class="img-captcha"></image>
		</view>
		<view class="uni-form-item uni-column column-with-btn">
		...
		<view class="uni-form-item uni-column">
			<input type="password" v-model="registerUser.password" class="uni-input" name="" placeholder="请输入密码" />
		</view>
